...
Author: Huy H. Nguyen
-----------------------------------------------------
Script for training Capsule-Forensics-v2 on CGvsPhoto database
"""
...
parser.add_argument('--dataset', default ='databases/cgvsphoto_patches', help='path to root dataset')
